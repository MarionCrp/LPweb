	...
	<body>
		...
		<div id="menu">
			...
			<ul>
				<?php
					...
					// $randomImgList = $imgDAO->getRandomImageList($img, $nbImg)
					...
					$randomImgId = $imgDAO->getRandomImage()->getId();
					$menu['Random']="zoom.php?zoom=1.25&imgId=$randomImgId&size=$size";
					...
					$newNbImgLess = $nbImg / 2;
					$menu['Less']="viewPhotoMatrix.php?imgId=$imgId&nbImg=$newNbImgLess";
					// Affichage du menu
		...
		<div id="corps">
			<?php # mise en place de la vue partielle : le contenu central de la page
				...
				$imgIdJumpBefore = $imgDAO->jumpToImage($img, - $nbImg)->getId();
				print "<a href=viewPhotoMatrix.php?imgId=$imgIdJumpBefore&nbImg=$nbImg>Prev</a> ";
				// pre-calcul de la page d'images suivante
				$imgIdJumpAfter = $imgDAO->jumpToImage($img, $nbImg)->getId();
				print "<a href=viewPhotoMatrix.php?imgId=$imgIdJumpAfter&nbImg=$nbImg>Next</a>\n";
				print "</p>\n";
